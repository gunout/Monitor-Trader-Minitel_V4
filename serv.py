...
FUNDAMENTAL_FALLBACK = {
    ...
    # ===== SPACE =====
    'SPCE': {'sector': 'Aerospace', 'industry': 'Space Tourism', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 1000000000, 'beta': 2.5, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 25, 'fifty_two_week_low': 5},
    'RKLB': {'sector': 'Aerospace', 'industry': 'Space Launch', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 2000000000, 'beta': 1.8, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 15, 'fifty_two_week_low': 4},
    'ASTS': {'sector': 'Telecom', 'industry': 'Space Mobile', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 1000000000, 'beta': 2.0, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 12, 'fifty_two_week_low': 2},
    'PL': {'sector': 'Satellite', 'industry': 'Earth Observation', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 800000000, 'beta': 1.5, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 8, 'fifty_two_week_low': 2},
    'RDW': {'sector': 'Aerospace', 'industry': 'Space Infrastructure', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 500000000, 'beta': 1.7, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 10, 'fifty_two_week_low': 3},
    'MNTS': {'sector': 'Aerospace', 'industry': 'Space Transportation', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 200000000, 'beta': 2.2, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 5, 'fifty_two_week_low': 1},
    'BKSY': {'sector': 'Satellite', 'industry': 'Earth Observation', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 300000000, 'beta': 1.6, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 6, 'fifty_two_week_low': 1},
    'GSAT': {'sector': 'Telecom', 'industry': 'Satellite Communications', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 1000000000, 'beta': 1.2, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 2, 'fifty_two_week_low': 1},
    'IRDM': {'sector': 'Telecom', 'industry': 'Satellite Communications', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 3000000000, 'beta': 0.8, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 50, 'fifty_two_week_low': 25},
    'UFO': {'sector': 'ETF', 'industry': 'Space ETF', 'pe_ratio': 'N/A', 'dividend_yield': 0.01, 'market_cap': 1000000000, 'beta': 1.3, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 25, 'fifty_two_week_low': 15},
    'ARKX': {'sector': 'ETF', 'industry': 'Space ETF', 'pe_ratio': 'N/A', 'dividend_yield': 0, 'market_cap': 1500000000, 'beta': 1.4, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 20, 'fifty_two_week_low': 10},
    'ROKT': {'sector': 'ETF', 'industry': 'Aerospace ETF', 'pe_ratio': 'N/A', 'dividend_yield': 0.015, 'market_cap': 800000000, 'beta': 1.0, 'eps': 'N/A', 'profit_margin': 'N/A', 'return_on_equity': 'N/A', 'debt_to_equity': 'N/A', 'fifty_two_week_high': 50, 'fifty_two_week_low': 35},
}
...
ASSETS = {
    ...
    'PL': {'name': 'Planet Labs', 'exchange': 'NYSE', 'category': 'SPACE', 'icon': '🛰️', 'color': '#3366cc', 'sector': 'Satellite'},
    'RDW': {'name': 'Redwire', 'exchange': 'NYSE', 'category': 'SPACE', 'icon': '🔧', 'color': '#ff8800', 'sector': 'Aerospace'},
    'MNTS': {'name': 'Momentus', 'exchange': 'NASDAQ', 'category': 'SPACE', 'icon': '🚀', 'color': '#00ccff', 'sector': 'Aerospace'},
    'BKSY': {'name': 'BlackSky', 'exchange': 'NYSE', 'category': 'SPACE', 'icon': '🛰️', 'color': '#003366', 'sector': 'Satellite'},
    'GSAT': {'name': 'Globalstar', 'exchange': 'NYSE', 'category': 'SPACE', 'icon': '📡', 'color': '#0066cc', 'sector': 'Telecom'},
    'IRDM': {'name': 'Iridium', 'exchange': 'NASDAQ', 'category': 'SPACE', 'icon': '📡', 'color': '#003366', 'sector': 'Telecom'},
    'UFO': {'name': 'Procure Space ETF', 'exchange': 'NASDAQ', 'category': 'SPACE', 'icon': '🛸', 'color': '#0044aa', 'sector': 'ETF'},
    'ARKX': {'name': 'ARK Space ETF', 'exchange': 'NASDAQ', 'category': 'SPACE', 'icon': '🚀', 'color': '#ff0055', 'sector': 'ETF'},
    'ROKT': {'name': 'SPDR Aerospace ETF', 'exchange': 'NYSE', 'category': 'SPACE', 'icon': '✈️', 'color': '#003399', 'sector': 'ETF'},
}
...
def get_watchlist():
    try:
        ...
        mock_prices = {
            ...
            '^GSPC': 5000.0, '^DJI': 38000.0, '^IXIC': 16000.0, '^FCHI': 7500.0,
            'RKLB': 8.0, 'SPCE': 12.0, 'ASTS': 6.0, 'PL': 4.0
        }
